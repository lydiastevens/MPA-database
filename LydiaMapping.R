...
shrimpmap <- shrimpmap + xlim(-80, -45) + ylim(42, 58)
...
shrimpmap <- shrimpmap + geom_point(data = shrimp2, aes(x=shrimp.longitude, y=shrimp.latitude, drop=FALSE), size = 1.0, shape =21, fill= "red")
